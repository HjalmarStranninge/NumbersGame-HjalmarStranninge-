namespace NumbersGame
{
    internal class Program
    {
        ...
        {
            static bool CheckGuess(int playerGuess, int correctNumber)      //Metod som testar om anvandaren gissat ratt, returnerar en bool
            {
                return playerGuess == correctNumber;
            }
            ...
            string[] wrongGuessLow = new string[]
            {
            ...
            string[] wrongGuessHigh = new string[]
            {
            ...
            try  //Förhindrar att programmet crashar vid ogiltig inmatning, t.ex bokstav
            {
                ...
                if (isCorrect) //Om min metod returnerar true så avslutas spelet
                {
                    Console.Clear();
                    ...
                    break;
                        ...
                        //och skriva ut en passande respons
                {
                    guessCount++;
